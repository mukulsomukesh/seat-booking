...
export default function InputBox({ fetchData }) {
    ...
    const handelAxiosPost = async () => {
        ...
        try {
            const response = await axios.post('https://ticket-booking-c1zw.onrender.com/api/seats/book', { numOfSeats: numberOfSeat });
    ...
    const handelResetBooking = async () => {
        ...
        try {
            const response = await axios.post('https://ticket-booking-c1zw.onrender.com/api/seats');
